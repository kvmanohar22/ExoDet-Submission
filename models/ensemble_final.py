...
steps = [
#    ('scaler', MinMaxScaler()),
    ('ensemble', AvgModel(powers=(1.2, 0.63, 0.53, 0.5, 0.64, 0.39, 0.27, 1.51, 1.6400000000000001, 1.78, 0.3, 1.06, 1.61), weights=(0.1, 0.25, 0.0, 1.25, 1.3, 0.25, 0.35000000000000003, 0.25, 0.7000000000000001, 1.4500000000000002, 0.5, 0.35000000000000003, 0.9)))
]
