...
steps = [
    ...
    ('pca', PCA(n_components=160,  random_state=random_seed)),
    ('xgb', xgb.XGBClassifier(n_estimators=4800, silent=True, nthread=3, max_depth=14, gamma=0.727499614488, colsample_bytree=0.9, subsample=0.907094588867, learning_rate=0.00711246340717, min_child_weight=19, seed=random_seed))
]
