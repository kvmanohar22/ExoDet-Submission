...
steps = [
    ...
    ('pca', PCA(n_components=130,  random_state=random_seed)),
    ('xgb', xgb.XGBClassifier(n_estimators=3450, silent=True, nthread=3, seed=random_seed, colsample_bytree=0.7, learning_rate=0.0453920867727, min_child_weight=7, subsample=0.883198326462, max_depth=20, gamma=0.0296639088028))
]
