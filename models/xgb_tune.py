...
steps = [
    ('xgb', xgb.XGBClassifier(n_estimators=9050, max_depth=21, min_child_weight=4, subsample=0.952889205256, gamma=0.00019905545888, colsample_bytree=0.95, learning_rate=0.0162300863273, silent=True, nthread=16, seed=random_seed))
]
